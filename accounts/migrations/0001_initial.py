    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('CEO', 'CEO'), ('HR', 'HR'), ('PM', 'Project Manager'), ('DEV', 'Developer'), ('UIUX', 'UI/UX Designer'), ('BDE', 'Business Development Executive')], max_length=50, unique=True)),
